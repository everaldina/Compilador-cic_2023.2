...
def preencher_tabela(tabela_transicao):
    ...
    tabela_transicao.loc["q4", '=']= 'TK_OP_GE'
    #q5
    tabela_transicao.loc["q5", '$']= 'q6'
    #q6
    tabela_transicao.loc["q6", '0':'9']= 'q6'
    tabela_transicao.loc["q6", '.']= 'q7'
    #q7
    ...
    tabela_transicao.loc["q9", '$']= 'q6'
    tabela_transicao.loc["q9", 'e']= 'q10'
    tabela_transicao.loc["q9", '.']= 'q13'
    #q10
    tabela_transicao.loc["q10", '0':'9']= 'q12'
    tabela_transicao.loc["q10", 'A':'F']= 'q12'
    tabela_transicao.loc["q10", '-']= 'q11'
    #q11
    ...
    tabela_transicao.loc["q14", 'e']= 'q10'
    #q15
    tabela_transicao.loc["q15", '='] = "TK_OP_ATRIBUICAO"
    #q16
    tabela_transicao.loc["q16", '='] = "TK_OP_DIF"
    #q17
    tabela_transicao.loc["q17", "'"] = "q18"
    #q18
